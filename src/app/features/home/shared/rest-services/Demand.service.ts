...
class DemandService {
    ...
    /**
    * This API will retrieve a list of demands based on the passed query parameters.

    * @method
    * @name Demand#getByTenantIdV1Demands
         ...
         * @param {string} shipNode - The ship node associated with the demand.
         * @param {string} tenantId - The IBM provided tenant ID to access your APIs.
    */
    public getByTenantIdV1Demands(parameters: {
        'itemId': string,
        'unitOfMeasure': string,
        'productClass': string,
        'shipNode': string,
    ...
    /**
    * This API will allow taking a list of incremental or decremental demands and processing asynchronously.

    * @method
    * @name Demand#postByTenantIdV1Demands
         * @param {} body - Input JSON
         * @param {string} tenantId - The IBM provided tenant ID to access your APIs.
    */
    public postByTenantIdV1Demands(parameters: {
        'body': AdjustDemandList,
        'tenantId': string,
        $queryParameters ? : any,
        $headers ? : any,
        $cache ? : any,
    ...
    /**
    * Sync API conditionally applies the difference between the sync and current delta quantity to the delta table. The synchronization action is performed only if the sync's sourceTs is greater than (or equals to) the last modified timestamp of the existing demand.

    * @method
    * @name Demand#putByTenantIdV1Demands
         * @param {} body - Input JSON
         * @param {string} tenantId - The IBM provided tenant ID to access your APIs.
    */
    public putByTenantIdV1Demands(parameters: {
        'body': SyncDemandList,
        'tenantId': string,
        $queryParameters ? : any,
        $headers ? : any,
